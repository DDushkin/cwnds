<pr-main class="col-md-9 right-content mainBlock" id="main" >
              ...
              <div class="row ">
                ...
                <div class="col-md-12">
                  ...
                  <div class="exp-holder margTop">
                    ...
                    <div class="exp">
                      <div class="hgroup">
                        <h4>WebDesigner – Mutation Media
                        </h4>
                        <h6>
                          <i class="icon-calendar"></i>Feb 2015 -
                          <span class="current">Current</span>
                        </h6>
                      </div>
                      <p>Ut enim ad minim veniam, quis nostrud exerc. Irure dolor in reprehend incididunt labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat inventore veritatis et quasi
                    ...
                    <div class="exp">
                      <div class="hgroup">
                        <h4>Web Developer – Mutation Media
                        </h4>
                        <h6>
                          <i class="icon-calendar"></i>Sept 2015 - Nov 2015</h6>
                      </div>
                      <p>Ut enim ad minim veniam, quis nostrud exerc. Irure dolor in reprehend incididunt labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat inventore veritatis et quasi
                        architecto beatae vitae dicta sunt explicabo.</p>
                    </div>
                    ...
                    <div class="exp">
                      <div class="hgroup">
                        <h4>SDK Developer – Mutation Media
                        </h4>
                        <h6>
                          <i class="icon-calendar"></i>May 2015 - Sept 2015</h6>
                      </div>
                      <p>Ut enim ad minim veniam, quis nostrud exerc. Irure dolor in reprehend incididunt labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat inventore veritatis et quasi
                        architecto beatae vitae dicta sunt explicabo.</p>
                    </div>
              ...
              <div class="row ">
                ...
                <div class="col-md-12">
                  ...
                  <div class="exp-holder margTop">
                    ...
                    <div class="exp">
                      <div class="hgroup">
                        <h4>Bachelor Degree – Mutation Media
                        </h4>
                        <h6>
                          <i class="icon-calendar"></i>Mar 2015 - May 2015</h6>
                      </div>
                      <p>Ut enim ad minim veniam, quis nostrud exerc. Irure dolor in reprehend incididunt labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat inventore veritatis et quasi
                        architecto beatae vitae dicta sunt explicabo.</p>
                    </div>
                    ...
                    <div class="exp">
                      <div class="hgroup">
                        <h4>Master Degree – Mutation Media
                        </h4>
                        <h6>
                          <i class="icon-calendar"></i>Sept 2015 - Nov 2015</h6>
                      </div>
                    ...
                    <div class="exp">
                      <div class="hgroup">
                        <h4>School Of Science – Mutation Media
                        </h4>
                        <h6>
                          <i class="icon-calendar"></i>May 2015 - Sept 2015</h6>
                      </div>
              ...
              <div class="row ">
                ...
                <div class="col-md-12">
                  ...
                  <div class="testi clearfix ">
                    ...
                    <ul id="testimonial-carousel" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
                      <div class="owl-wrapper-outer">
                        <div class="owl-wrapper" style="width: 3072px; left: 0px; display: block;">
                          <div class="owl-item" style="width: 768px;">
                            <li>

                              <div class="block-quote">
                                <div class="block-img"><img alt="" src="img/testimonial/1.jpg"></div>
                                <div class="block-icon">
                                  <i class="icon-quote"></i>
                                </div>
                                <h3 class="block-profile">Carlose Smith
                                  <span>
                                    CEO / Split Inc</span>
                                </h3>
                          ...
                          <div class="owl-item" style="width: 768px;">
                            <li>
                              <div class="block-quote">
                                <div class="block-img"><img alt="" src="img/testimonial/2.jpg"></div>
                                <div class="block-icon">
                                  <i class="icon-quote"></i>
                                </div>
