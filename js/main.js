...
function opener(el){
  ...
  switch (n) {
    case 'kids': riot.mount('land', {title: 'Kids camp',
                                    ...
                                    img: 'line',
                                    text1: 'Ти втомився гребти та шукаєш попутний вітер? Табір Cross Winds - ковток свіжого повітря для твоїх вітрил. Ми допоможемо тобі побачити наскільки яскравим може бути життя на фоні сірих буднів.<br>Ми пропонуємо тобі:',
                                    ...
                                    offer5: 'Не вистачає адреналіну? Стань учасником веселих командних змагань. <br>P.S. На переможців чекають американські смаколики.',
                                    ...
                                    info1: 'Денний табір на базі Боярської школи №5 <br>( + команда з 18-ти американців)',
